...
CodeMirror.defineSimpleMode("nsis",{
  start:[
    ...
    {regex: /^\s*(?:\!(addincludedir|addplugindir|appendfile|cd|define|delfile|Print|error|execute|finalize|getdllversion|gettlbversion|include|insertmacro|macro|macroend|makensis|packhdr|pragma|searchparse|searchreplace|system|tempfile|undef|uninstfinalize|verbose|warning))\b/i, token: "keyword"},
