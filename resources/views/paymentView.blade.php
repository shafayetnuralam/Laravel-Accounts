    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0"> Payment View Last 100 Entrys</h1>
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                  ...
                  data-whatever="Payment">Add New</button></li>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Are you sure you want to delete the Payment Invoice"<strong id="deletePaymentName"></strong>"?</p>
...
<script>
  ...
  $('#paymentView').on('click', '.edit-btn', function() {
  ...
  $('#paymentView').on('click', '.delete-btn', function() {
    const id = $(this).data('id');
  ...
  $('#confirmDelete').click(function() {
    const id = $(this).data('id');
    $.ajax({
      url: "{{ route('payments.destroy', ':id') }}".replace(':id', id),
      type: 'DELETE',
      headers: {
        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
      },
  ...
  //Payment Add
      $('#modal-default1').on('show.bs.modal', function (event) {
        ...
        if(ID =='Payment'){
          ...
          modal.find('.modal-title').text('Payment Add');
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            // Fetch last invoice number for new payments
            $.ajax({
              url: "{{ route('payments.getLastInvoice') }}",
              type: 'GET',
              headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
              },
      ...
      }else if (ID && ID !='Payment'){

          modal.find('.modal-title').text('Payment Update');
          $.ajax({
          type: "GET",
